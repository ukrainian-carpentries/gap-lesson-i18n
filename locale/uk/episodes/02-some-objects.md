...
які існують у GAP. Більш того, у GAP можна самостійно вводити нові типи
...
Іншим типом складених об’єктів є **записи**. У той час як список містить підоб’єкти, проіндексовані
за їх позиціями в списку, запис містить підоб’єкти, які називаються _компонентами
запису_ та індексуються за своїми іменами. Елементи запису доступні за допомогою символу `.` (крапка).
...
є такими ж простими об’єктами, як, наприклад, цілі числа.
...
`Maximum`. Якщо список довгий, це може зайняти більше часу та потребує більше пам’яті. Спробуйте написати код, який знаходить літери, які найчастіше зустрічаються в рядку `c`, не створюючи проміжного списку.
