...
Ми почнемо з дуже прямого підходу, перебираючи
...
щоб помістити в один рядок, і використати подвійну крапку з комою, щоб не виводити значення змінної `sum`:
...
має бути збережена в змінній з іменем `S`, тому або ми повинні визначати `S` знов кожного
...
- група, про яку йде мова, може міститися в іншій змінній, і тому код
  доведеться змінити;
