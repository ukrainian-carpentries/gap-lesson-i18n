...
- Дивіться більше в [GAP Tutorial: Lists and Records](https://www.gap-system.org/Manuals/doc/tut/chap3.html)
...
дозволить вам перебирати більшість типів об’єктів). We have to switch to using `Size`
