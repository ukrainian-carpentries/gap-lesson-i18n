...
Отриманий результат є списком. Списки в GAP індексуються від 1, на відміну від, наприклад, мови Python.
...
- Якщо обчислення триває занадто довго, натисніть <Control>\-C, щоб перервати його. Потім введіть `quit`; щоб повернутись до головної сесії GAP.
