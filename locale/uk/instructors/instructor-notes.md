...
1. Розв'язання задачі: `Sum(List(Filtered([1..2000], n -> not IsPrimePowerInt(n)),NrSmallGroups)); NrSmallGroups(1536); last2-last;`.
   Крім `SmallGroup(105,1)` та `SmallGroup(357,1)`, іншою групою є `SmallGroup(1785,1)`.
