...
- Підкресліть, що банер містить інформацію про версію GAP. Ці дані корисні для цитування GAP або повідомлення про помилки. Вибір пакетів може відрізнятися, але відсутність пакетів **IO** та
